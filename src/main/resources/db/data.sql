...
INSERT INTO widget (name, url, action_url, description) VALUES
                                                     ('CURRENCY', 'http://auth-service:3010/', 'http://auth-service:3010/currency','Курсы валют из ЦБ'),
                                                     ('MESSAGE', 'http://auth-service:3020/', null ,'Tех поддержка');
--                                                     ('MESSAGE', 'http://auth-service:3020/', null,'Tех поддержка');
